        ...
        >
          {isAuthenticated ? (
            <Menu>
              ...
              <MenuList>
                <MenuItem as={RouterLink} to="/tenant/profile">My Profile</MenuItem>
                <MenuItem as={RouterLink} to="/tenant/bookings">My Bookings</MenuItem>
                <MenuItem as={RouterLink} to="/tenant/invoices">My Invoices</MenuItem>
                <MenuItem as={RouterLink} to="/tenant/payments">Payment History</MenuItem>
                <MenuDivider />

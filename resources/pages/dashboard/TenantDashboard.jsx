...
const TenantDashboard = () => {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      ...
      console.log('Tenant ID (alt):', tenant?.id);
      
      if (!tenant?.tenantId) {
        console.log('No tenant ID available, skipping dashboard fetch');
        setLoading(false);
        return;
      }
      ...
      try {
        console.log('Fetching dashboard data for tenant:', tenant.tenantId);
          // Fetch bookings
        ...
        if (bookingsResponse && bookingsResponse.bookings) {
          ...
          console.log('Active booking dates:', {

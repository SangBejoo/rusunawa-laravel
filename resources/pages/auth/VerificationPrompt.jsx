...
const VerificationPrompt = () => {
  ...
  useEffect(() => {
    ...
    if (isAuthenticated && tenant?.isVerified && !location.state?.fromRegistration) {
      navigate('/tenant/dashboard');
    }
  }, [isAuthenticated, tenant, navigate, location.state]);
  ...
  useEffect(() => {
    ...
    if (isVerified) {      // If already verified, redirect to login or dashboard
      if (isAuthenticated) {
        navigate('/tenant/dashboard');

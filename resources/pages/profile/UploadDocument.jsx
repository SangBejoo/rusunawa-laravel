...
import { FaFileAlt, FaUpload, FaArrowLeft } from 'react-icons/fa'; // Ensure FaUpload is imported
...
const UploadDocument = () => {
  ...
  const [isSubmitting, setIsSubmitting] = useState(false); // Use this for loading state
  const [error, setError] = useState(''); // This is already used for displaying errors

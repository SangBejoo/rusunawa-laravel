...
const paymentService = {
  ...
  createManualPayment: async (paymentData) => {
    try {
      const config = getConfig();
      console.log('=== PaymentService.createManualPayment ===');
      console.log('API_URL:', API_URL);
      console.log('Full endpoint:', `${API_URL}/payments/manual`);
      ...
      console.error('=== Manual payment API error ===');
  ...
  getTenantPaymentsWithProof: async (tenantId, params = {}) => {
    try {
      console.log('Getting tenant payments with proof for tenant:', tenantId, 'with params:', params);
      ...
      console.log('Tenant payments with proof response:', data);
      ...
      console.error('Error getting tenant payments with proof:', error);
      throw error;
    }
  },
